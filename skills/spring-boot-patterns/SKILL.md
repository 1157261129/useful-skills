...
description: Guides Java Spring Boot controllers, services, repositories, DTOs, validation, exception handling, configuration, transactions, and tests. Use when creating or reviewing Spring Boot Java code, REST endpoints, service layers, repository access, configuration properties, or application structure.
---
...
See [EXAMPLES.md](EXAMPLES.md) for Spring Boot examples.
