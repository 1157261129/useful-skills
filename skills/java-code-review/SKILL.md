...
description: Performs systematic Java code review for correctness, null safety, exceptions, collections, resources, APIs, concurrency, performance, and tests. Use when reviewing Java files, Spring code, Java pull requests, recent Java diffs, or pre-merge changes.
---
...
See [EXAMPLES.md](EXAMPLES.md) for Java code review examples.
