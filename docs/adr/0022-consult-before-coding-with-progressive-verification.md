...
- No-result tag queries may first remap to a better canonical tag from the vocabulary, then broaden once without tag filters. Persistent no-result outcomes are reported as no reusable catalog entry found.
